...
class SqlManagerTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sql_manager.register('Annie', 'asdasd')
    ...
    def test_sql_injection_username(self):
        logged_user = sql_manager.login("Annie'--", 'blabla')
    ...
    def test_username_or_passoword_with_quotes(self):
        self.assertRaises(ValueError, sql_manager.register, ("asd'--"), ("dad'--"))
